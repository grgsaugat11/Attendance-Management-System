  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.InputContainer}>
        ...
        <TextInput style={styles.TextInput} placeholder="Faculty ID" secureTextEntry />
      </View>
      <Text style={styles.forgotPasswordText}>Forgot your Faculty ID?</Text>
...
export default LoginScreenTeacher;